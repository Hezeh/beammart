    ...
    return SafeArea(
      child: ListView(
        children: [
          ...
          // Search bar
          SearchBarWidget(),
          // _locProvider.locationPermission == LocationPermission.denied
                                        ...
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
                                            builder: (_) => ItemDetail(
                                              ...
                                              merchantId:
                                                  _items[item].businessId,
                                              locationDescription: _items[item]
                                                  .locationDescription,
                                              merchantDescription: _items[item]
                                                  .businessDescription,
                                              merchantName:
                                                  _items[item].businessName,
                                              merchantPhotoUrl:
                                                  _items[item].merchantPhotoUrl,
                                              phoneNumber:
                                              ...
                                              tuesdayOpeningTime: _items[item]
                                                  .tuesdayOpeningHours,
                                              wednesdayClosingTime: _items[item]
                                                  .wednesdayClosingHours,
                                              wednesdayOpeningTime: _items[item]
                                                  .wednesdayOpeningHours,
                                              thursdayClosingTime: _items[item]
                                                  .thursdayClosingHours,
                                              thursdayOpeningTime: _items[item]
                                                  .thursdayOpeningHours,
                                              fridayClosingTime: _items[item]
                                                  .fridayClosingHours,
                                              fridayOpeningTime: _items[item]
                                                  .fridayOpeningHours,
                                              saturdayClosingTime: _items[item]
                                                  .saturdayClosingHours,
                                              saturdayOpeningTime: _items[item]
