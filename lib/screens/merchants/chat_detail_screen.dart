...
class MerchantChatDetailScreen extends StatefulWidget {
  final String? chatId;
  final String? consumerName;

  MerchantChatDetailScreen({
    Key? key,
  ...
  @override
  _MerchantChatDetailScreenState createState() => _MerchantChatDetailScreenState();
}

class _MerchantChatDetailScreenState extends State<MerchantChatDetailScreen> {
