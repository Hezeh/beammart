import 'package:beammart/enums/mens_fashion.dart';
    ...
    _postItem() async {
      if (_mensFashionFormKey.currentState!.validate()) {
        ...
        if (_profileProvider.profile!.tokensBalance != null &&
            _categoryTokensProvider.categoryTokens!.mensFashionTokens != null) {
          final double requiredTokens =
              _categoryTokensProvider.categoryTokens!.mensFashionTokens!;
