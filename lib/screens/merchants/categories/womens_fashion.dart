import 'package:beammart/enums/womens_fashion.dart';
    ...
    _postItem() async {
      if (_womensFashionFormKey.currentState!.validate()) {
        ...
        if (_profileProvider.profile!.tokensBalance != null &&
            _categoryTokensProvider.categoryTokens!.womensFashionTokens != null) {
          final double requiredTokens =
              _categoryTokensProvider.categoryTokens!.womensFashionTokens!;
