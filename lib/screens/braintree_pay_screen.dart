...
class BraintreePayScreen extends StatefulWidget {
  const BraintreePayScreen({Key? key}) : super(key: key);

  @override
  State<BraintreePayScreen> createState() => _BraintreePayScreenState();
}

class _BraintreePayScreenState extends State<BraintreePayScreen> {
