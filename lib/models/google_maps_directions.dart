class GoogleMapsDirections {
  ...
  GoogleMapsDirections({ this.geocodedWaypoints, this.routes, this.status});

  GoogleMapsDirections.fromJson(Map<String, dynamic> json) {
...
class Routes {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.warnings != null) {
      data['warnings'] = this.warnings!.map((v) => v).toList();
    }
    if (this.waypointOrder != null) {
      data['waypoint_order'] =
          this.waypointOrder!.map((v) => v).toList();
    }
    return data;
  }
}
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.trafficSpeedEntry != null) {
      data['traffic_speed_entry'] =
          this.trafficSpeedEntry!.map((v) => v).toList();
    }
    if (this.viaWaypoint != null) {
      data['via_waypoint'] = this.viaWaypoint!.map((v) => v).toList();
    }
    return data;
  }
}
